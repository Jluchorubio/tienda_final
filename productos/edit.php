...
<style>
    ...
    .card{
        background:white;padding:20px;max-width:700px;margin:auto;
    ...
    button{padding:10px 15px;border:none;border-radius:6px;color:white;cursor:pointer}
    .save{background:#28a745}
    .cancel{background:#6c757d;text-decoration:none;padding:10px 15px;color:white;border-radius:6px}
</style>
